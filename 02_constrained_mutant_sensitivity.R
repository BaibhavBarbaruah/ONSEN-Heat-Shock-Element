...
# Supports final Table S3. AP2/ERF plot exports are retained as exploratory
# diagnostics and are not part of the final supplementary-figure set.
...
if (ONSEN_MAKE_FIGURES) {
  ...
  p_s3a <- ggplot2::ggplot(
    ...
    theme_onsen(13)
  save_plot_pair(p_s3a, "Diagnostic_random_mutant_AP2ERF_distribution", 6.5, 4.8)

  # Exploratory diagnostic B
  p_s3b <- ggplot2::ggplot(
    ...
    theme_onsen(13)
  save_plot_pair(p_s3b, "Diagnostic_random_mutant_GC_correlation", 6.5, 4.8)

  # Exploratory diagnostic C
  p_s3c <- ggplot2::ggplot(
    ...
    theme_onsen(13)
  save_plot_pair(p_s3c, "Diagnostic_exact_GC_AP2ERF_distribution", 6.5, 4.8)
}
