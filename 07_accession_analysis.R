...
# Covers Fig. 6, Fig. 7, Fig. S3, Fig. S4 and source data for Tables S11-S13.
...
if (ONSEN_MAKE_FIGURES) {
  ...
  save_plot_pair(p_s1a, "FigS4A_accession_candidate_abundance", 7.0, 5.2)
  ...
  save_plot_pair(p_s1b, "FigS4B_accession_HSF_density", 7.0, 5.2)
  ...
  if (!is.na(paired_col)) {
    ...
    save_plot_pair(p_s1c, "FigS4C_paired_unpaired_proxies", 7.0, 5.2)
  }
